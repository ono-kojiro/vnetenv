...
#
# japanese keyboard configuration
#
# See https://wiki.archlinux.jp/index.php/X_keyboard_extension

change_keymap()
{
  if [ "$DISPLAY" = ":0" ]; then
    xkbcomp /tmp/japanese.xkb $DISPLAY 2>/dev/null
    rm -f /tmp/japanese.xkb
  fi  
}

cat - << EOF > /tmp/japanese.xkb
xkb_keymap {
